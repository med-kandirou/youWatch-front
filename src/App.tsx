...
<div className="bg-white font-sans">
    <nav className="py-2 shadow">
        <div className="container mx-auto flex items-center">
            <div className="w-1/5">
                <a href="#" className="mr-6"><i className="fa fa-bars fa-lg" aria-hidden="true"></i></a>
                <a href="#" className="text-red-light tracking-tight">
                <i className="fa fa-youtube-play fa-lg" aria-hidden="true"></i>
                <span className="text-black font-bold tracking-tight">YouTube</span>
                </a>
            </div>
            <div className="w-3/5">
                <div className="relative">
                    <input type="text" className="h-8 p-4 text-sm w-full border" placeholder="Search"/>
                    <span className="flex items-center bg-grey-lightest hover:bg-grey-lighter absolute pin-r pin-y border px-8"><i className="fa fa-search text-grey-dark"></i></span>
                </div>
            </div>
            <div className="w-1/5">
        ...
        <div className="container mx-auto">
            ...
            <div className="px-16">
                <ul className="list-reset flex">
                    ...
                    <li className="text-center py-3 px-8"><i className="fa fa-search fa-lg text-grey-dark"></i></li>
                </ul>
            </div>
        </div>
    </div>
            ...
            <div className="border-b pb-8">
                <div className="flex">
                    <div className="w-3/4 flex">
                        <div>
                            <img className="block w-full" src="https://i.ytimg.com/vi/Kcie9rbbb4s/hqdefault.jpg?sqp=-oaymwEXCNACELwBSFryq4qpAwkIARUAAIhCGAE=&rs=AOn4CLCbowulw74TtG_RM8mhfoyq3tya9A" alt=""/>
                        </div>
                        <div className="pl-4">
                    ...
                    <div className="w-1/4">
                        <div>
                            <img className="block w-100" src="https://i.ytimg.com/vi/TubVp9nn32Q/hqdefault.jpg?sqp=-oaymwEXCPYBEIoBSFryq4qpAwkIARUAAIhCGAE=&rs=AOn4CLAUxQM30HpBNOg3UpiPQUISQgwSlg" alt=""/>
                        </div>
                        <div>
            ...
            <div className="border-b">
                ...
                <div className="flex mb-4 relative">
                    <div className="absolute w-10 h-10 rounded-full bg-white text-grey-dark text-center -mr-3 pin-r mt-8 shadow-md">
                        <i className="fa fa-chevron-right mt-3" aria-hidden="true"></i>
                    </div>
        ...
        <div className="w-1/4 py-6">
            <div className="border-b">
                ...
                <ul className="list-reset">
                    <li className="mb-6">
                        ...
                        <img className="w-6 h-6 rounded-full" src="https://yt3.ggpht.com/-E0Ej_rdX5Ic/AAAAAAAAAAI/AAAAAAAAAAA/kskO1deXSNs/s88-c-k-no-mo-rj-c0xffffff/photo.jpg" alt=""/>
                    ...
                    <li className="mb-6">
                        <span className="flex items-center mb-2">
                        <img className="w-6 h-6 rounded-full" src="https://yt3.ggpht.com/-X6Szi46cleA/AAAAAAAAAAI/AAAAAAAAAAA/XJsGnNESQs8/s88-c-k-no-mo-rj-c0xffffff/photo.jpg" alt="" />
                    ...
                    <li className="mb-6">
                        <span className="flex items-center mb-2">
                        <img className="w-6 h-6 rounded-full" src="https://yt3.ggpht.com/-Lvqivbc77hw/AAAAAAAAAAI/AAAAAAAAAAA/YSd9RXOp_Ng/s88-c-k-no-mo-rj-c0xffffff/photo.jpg" alt=""/>
                    ...
                    <li className="mb-6">
                        <span className="flex items-center mb-2">
                        <img className="w-6 h-6 rounded-full" src="https://yt3.ggpht.com/-1rYs64e24jQ/AAAAAAAAAAI/AAAAAAAAAAA/B2LPB2yW030/s88-c-k-no-mo-rj-c0xffffff/photo.jpg" alt=""/>
                    ...
                    <li className="mb-6">
                        <span className="flex items-center mb-2">
                        <img className="w-6 h-6 rounded-full" src="https://yt3.ggpht.com/-kHTbb6oDqmY/AAAAAAAAAAI/AAAAAAAAAAA/BHWd_jlJmJU/s88-c-k-no-mo-rj-c0xffffff/photo.jpg" alt=""/>
                    ...
                    <li className="mb-6">
                        <span className="flex items-center mb-2">
                        <img className="w-6 h-6 rounded-full" src="https://yt3.ggpht.com/-pX2m-odRVjo/AAAAAAAAAAI/AAAAAAAAAAA/kVOqkSiGTaA/s88-c-k-no-mo-rj-c0xffffff/photo.jpg" alt=""/>
            ...
            <div className="py-6">
                ...
                <ul className="list-reset">
                    <li className="mb-6">
                        <span className="flex items-center mb-2">
                        <img className="w-6 h-6 rounded-full" src="https://yt3.ggpht.com/-5aj55jp4Jm8/AAAAAAAAAAI/AAAAAAAAAAA/aMg0g6GjNJ8/s88-c-k-no-mo-rj-c0xffffff/photo.jpg" alt=""/>
                    ...
                    <li className="mb-6">
                        <span className="flex items-center mb-2">
                        <img className="w-6 h-6 rounded-full" src="https://yt3.ggpht.com/-OsgBxXITFdg/AAAAAAAAAAI/AAAAAAAAAAA/gDaUV_aSb2Q/s88-c-k-no-mo-rj-c0xffffff/photo.jpg" alt=""/>
                    ...
                    <li className="mb-6">
                        <span className="flex items-center mb-2">
                        <img className="w-6 h-6 rounded-full" src="https://yt3.ggpht.com/--JVzzRDG2ME/AAAAAAAAAAI/AAAAAAAAAAA/Q-LECA0Cxb8/s88-c-k-no-mo-rj-c0xffffff/photo.jpg" alt=""/>
                    ...
                    <li className="mb-6">
                        <span className="flex items-center mb-2">
                        <img className="w-6 h-6 rounded-full" src="https://yt3.ggpht.com/-yZnkNC2qlCU/AAAAAAAAAAI/AAAAAAAAAAA/qgA6rParUds/s88-c-k-no-mo-rj-c0xffffff/photo.jpg" alt=""/>
                    ...
                    <li className="mb-6">
                        <span className="flex items-center mb-2">
                        <img className="w-6 h-6 rounded-full" src="https://yt3.ggpht.com/-9X-_QJu0RvQ/AAAAAAAAAAI/AAAAAAAAAAA/X3cPcZ5icto/s88-c-k-no-mo-rj-c0xffffff/photo.jpg" alt=""/>
