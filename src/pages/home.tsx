        ...
        <div className="bg-white">
            ...
            <div className="flex">
                ...
                <div className="flex items-center space-x-2">
                    ...
                    <button className="font-medium">Accueil</button>
                </div>
                <div className="flex items-center space-x-2">
                    <svg
                    xmlns="http://www.w3.org/2000/svg"
                    ...
                    <button className="font-medium">Tous</button>
                </div>
                <div className="flex items-center space-x-2">
                    <svg
                    xmlns="http://www.w3.org/2000/svg"
                    ...
                    <button className="font-medium">Musique</button>
                </div>
                <div className="flex items-center space-x-2">
                    <svg
                    xmlns="http://www.w3.org/2000/svg"
                    ...
                    <button className="font-medium">Abonnements</button>
                </div>
                </div>
